...
//        return DRAW; //shouldn't get here
        ...
        //I came up with an algorithm  based on your static constants of the 3 items
        if (playerMove - gameMove == -2 || playerMove - gameMove == 1) {
            return WIN;
        } else if (playerMove - gameMove == 2 || playerMove - gameMove == -1) {
            return LOSE;
        } else {
            return DRAW;
        }
